...
public class jdbc {
	...
	public static void main(String args[]) throws SQLException {
		...
		try {
			...
			conn= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/demo","student","student@123");
	        ...
	        */
			...
			//BLOB
			File file = new File("C:\\Adwait\\RESUME and Other\\Job applications\\Resume.docx");
			...
			File outFile = new File ("C:\\Adwait\\RESUME and Other\\Job applications\\Resume DB.docx");
			...
			File file1 = new File("C:\\Adwait\\RESUME and Other\\Job applications\\Resume.docx");
			...
			File outFile1 = new File("C:\\Adwait\\RESUME and Other\\Job applications\\DB.docx");
